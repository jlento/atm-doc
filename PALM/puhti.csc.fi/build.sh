...
install_root=$(projappl)/palm-6.0
mkdir -p $install_root/{include/rrtmg-static,include/rrtmg-dynamic,lib}

module purge
module load intel/19.0.4 hpcx-mpi/2.4.0 fftw/3.3.8-mpi hdf5/1.10.4-mpi netcdf/4.7.0 netcdf-fortran/4.4.4 makedepf90
